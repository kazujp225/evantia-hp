                ...
                {SLIDES.map((slide, index) => (
                    index === currentSlide && (
                        ...
                        >
                            ...
                            <div className="relative w-full h-auto min-h-[60%] lg:h-full lg:w-[45%] bg-zinc-50 md:bg-zinc-50/50 md:backdrop-blur-sm flex flex-col justify-start lg:justify-center px-6 md:px-12 lg:px-20 z-10 lg:border-r border-zinc-200/50 border-b lg:border-b-0 pt-24 pb-12 md:py-0 transition-all duration-300">
                            ...
                            <div className="relative flex-1 h-full min-h-0 overflow-hidden bg-zinc-100">
                                <motion.div
